...
public class UserMediaTypeVersioningController {
    ...
    @GetMapping(value = "/{id}", produces = "application/vnd.garima.app-v1+json")
    ...
    //Media Type Based Versioning Version 2 -- Accept header
    @GetMapping(value = "/{id}", produces = "application/vnd.garima.app-v2+json")
